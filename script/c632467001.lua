...
function s.initial_effect(c)
	...
	e1:SetValue(1)
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(id,ACTIVITY_SPSUMMON,function(c) return c:IsLocation(LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE) and c:IsType(TYPE_GEMINI) end)
