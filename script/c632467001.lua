...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(id,ACTIVITY_SPSUMMON,function(c) return not c:IsType(TYPE_GEMINI) and c:IsSummonLocation(LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE) end)
