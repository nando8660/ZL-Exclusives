...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(id,ACTIVITY_SPSUMMON,function(c) return (c:IsType(TYPE_GEMINI) and c:IsSummonLocation(LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE)) or c:IsSummonLocation(LOCATION_EXTRA) end)
