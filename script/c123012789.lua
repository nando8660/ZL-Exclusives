...
function s.addcounter(e,tp,eg,ep,ev,re,r,rp)
	...
	Debug.Message("Registro de LP após o ganho: "..Duel.GetFlagEffectLabel(tp,107).." - tp: "..(tp))
end
...
--     end
--     Debug.Message("Registro de LP após dano: "..Duel.GetFlagEffectLabel(tp,107).." - tp: "..(tp))
-- end
