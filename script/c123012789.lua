...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RegisterFlagEffect(tp,id107,0,0,0)
	...
	Debug.Message("Registro de LP: "..Duel.GetFlagEffectLabel(tp,id107))
end
...
function s.addcounter(e,tp,eg,ep,ev,re,r,rp)
	local flag=Duel.GetFlagEffectLabel(tp,id107)
	if not flag then
		Duel.RegisterFlagEffect(tp,id,RESET_PHASE+PHASE_END,0,1,0)
		Duel.SetFlagEffectLabel(tp,id107,ev)
	else
		Duel.SetFlagEffectLabel(tp,id107,flag+ev)
	end
	Debug.Message("Registro de LP após o ganho: "..Duel.GetFlagEffectLabel(tp,id107))
end
...
--         Duel.SetFlagEffectLabel(tp,id107,new_val)
--     end
--     Debug.Message("Registro de LP após dano: "..Duel.GetFlagEffectLabel(tp,id107))
-- end
